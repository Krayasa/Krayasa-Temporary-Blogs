...
readonly LOCAL_DOMAIN=speedwingshr.com.test:8082
readonly SSH_HOST=deploy@speedwingshr.com
...
ssh $SSH_HOST "export PGUSER=postgres && pg_dump job_portal_wagtail --no-owner > /tmp/db-dump.sql"
